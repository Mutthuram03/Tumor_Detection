...
DATA_DIR = './dataset'
MODEL_SAVE_PATH = './saved_models/best_resnet18.pth'
...
def main():
    ...
    try:
        ...
        print(f"Error: Dataset not found in {DATA_DIR}. Please place 'Tumor' and 'No_Tumor' folders inside.")
        return
    ...
    # For strict separation we'd copy dataset object, but for simplicity here we override transform 
    ...
    save_plots(train_losses, val_losses, train_accs, val_accs, "ResNet18", "./outputs/plots")
